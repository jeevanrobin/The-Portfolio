...
const SECTION_AURAS = {
  home:        { c1:"rgba(78,133,191,0.28)",  c2:"rgba(137,170,204,0.20)", p1:"20% 20%", p2:"80% 80%" },
  works:       { c1:"rgba(60,100,180,0.22)",  c2:"rgba(100,140,220,0.16)", p1:"10% 40%", p2:"90% 60%" },
  journal:     { c1:"rgba(100,80,200,0.20)",  c2:"rgba(80,120,200,0.16)",  p1:"50% 20%", p2:"50% 80%" },
  explorations:{ c1:"rgba(60,150,120,0.18)",  c2:"rgba(80,160,140,0.14)",  p1:"30% 60%", p2:"70% 30%" },
  stats:       { c1:"rgba(78,133,191,0.20)",  c2:"rgba(137,170,204,0.16)", p1:"60% 40%", p2:"40% 70%" },
  about:       { c1:"rgba(78,133,191,0.20)",  c2:"rgba(100,150,200,0.15)", p1:"15% 50%", p2:"85% 50%" },
  skills:      { c1:"rgba(60,100,160,0.18)",  c2:"rgba(120,160,210,0.14)", p1:"80% 20%", p2:"20% 80%" },
  experience:  { c1:"rgba(78,133,191,0.22)",  c2:"rgba(137,170,204,0.18)", p1:"25% 30%", p2:"75% 70%" },
  contact:     { c1:"rgba(78,133,191,0.28)",  c2:"rgba(137,170,204,0.22)", p1:"20% 20%", p2:"80% 80%" },
};
